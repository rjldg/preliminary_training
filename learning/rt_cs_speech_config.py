...
speech_config.speech_recognition_language="zh-CN"   # Source language config
...
'''
audio_config = speechsdk.audio.AudioConfig(filename='data/synthesized_audio_data/testaudio_ch.wav')
